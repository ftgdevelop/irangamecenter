    ...
    return (
        ...
        >
            <div className="fixed top-0 left-0 right-0 bottom-0 flex z-50 justify-center items-center">
                ...
                <div className={`bg-white dark:bg-[#192a39] text-neutral-800 dark:text-white items-center p-5 max-w-80 w-10/12 justify-center flex flex-col rounded-2xl transition-all ${open ? "translate-x-0" : "-translate-x-full"}`}>
