...
const OtpInput: React.FC<Props> = props => {
    ...
    return (
        ...
        <div className='grid grid-cols-6 gap-1.5 font-sans max-w-96 mx-auto' dir="ltr" id="otp_Input_wrapper">
            {fields.map(item => (
                <input
                    key={item.index}
                    type='text'
                    ...
                    className="border-[#192b39] bg-[#192b39] rounded-full aspect-square text-center appearance-none noStyleInputNumber text-left"
