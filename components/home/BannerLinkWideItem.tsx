...
const BannerLinkWideItem:React.FC<Props> = props => {
    return (
        <div className={`relative ${props.wrapperClassName || ""}`}>
            ...
            />
            <Link prefetch={false} href={props.url} className="h-20 px-4 bg-[#1b2c3b] absolute bottom-0 left-0 flex justify-between gap-7 items-center rounded-bl-3xl rounded-tr-3xl">
